...
export default function MobileNav() {
  ...
  const userBottomItems = [
    ...
    { path: '/hit-list', label: 'Hit List', icon: <HiIdentification size={20} /> },
  ...
  const adminBottomItems = [
    { path: '/admin', label: 'Admin', icon: <HiUsers size={20} /> },
  ];

  const bottomItems = isAdmin ? adminBottomItems : isAuthority ? authorityBottomItems : userBottomItems;
